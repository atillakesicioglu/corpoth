...
<main id="main" class="pt-20">
  <?php
  extract(page_hero_load('hizmet-detay', [
    'hero_eyebrow'  => 'Hizmet',
    'hero_title'    => 'Kurumsal Omurga Terapisi',
    'hero_subtitle' => 'Çalışanlarınızın masasından kalkmadan, ofise gelen profesyonel terapi hizmeti.',
  ]));
